...
const HTPCard = ({ image, number, title, description }) => {
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView={"show"}
      className="bg-white py-[10px] px-[17px] max-w-full w-auto h-full text-center"
    >
      ...
      <div className="flex items-center justify-center mb-2">
        <div
          className="w-8 h-8 flex items-center justify-center bg-[#032071] text-white rounded-full mr-2 text-lg font-bold"
          style={{
            boxShadow:
